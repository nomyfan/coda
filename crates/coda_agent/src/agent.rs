...
use coda_core::llm::{
    AssistantMessage, ChatCompletionRequest, CompactionMessage, Message, MessageId,
    TaskNoticeOutcome, ToolCall, ToolCallOutcome, ToolDefinition, ToolMessage, ToolOutput, TurnId,
};
...
/// Events produced as a process advances or resumes an execution.
#[derive(Debug, Clone)]
pub enum AgentEvent {
    ApprovalRemoved {
        pid: String,
